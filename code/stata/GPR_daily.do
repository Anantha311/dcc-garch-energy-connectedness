log using "tvgc_results_gpr_daily.log", replace text
clear all
set scheme sj
set more off
...
import delimited "C:\Users\Anantha\OneDrive\Desktop\Anantha\BITS GOA\Academics\3 - 1\FRAM\Project\Data\Daily\TCI_GPR_daily", clear
rename *, lower
...
foreach var of varlist tci gpr {
	gen d`var' = d.`var'
}
...
varsoc tci gpr /* if tin(1992m1,) */ , exog(trend) maxlag(12)
