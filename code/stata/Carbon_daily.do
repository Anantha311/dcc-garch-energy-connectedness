log using "tvgc_results_carbon_daily.log", replace text
clear all
set scheme sj
set more off
...
import delimited "C:\Users\Anantha\OneDrive\Desktop\Anantha\BITS GOA\Academics\3 - 1\FRAM\Project\Data\Daily\TCI_Carbon_daily", clear
rename *, lower
...
foreach var of varlist tci carbon {
	gen d`var' = d.`var'
}
...
varsoc tci carbon /* if tin(1992m1,) */ , exog(trend) maxlag(12)
...
tvgc `yvar' `xvar', trend win(504) sizec(252) p(2) d(1) seed(123) boot(499) prefix(fig_y1_d1_) graph pdf notitle
log close
