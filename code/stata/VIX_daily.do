log using "tvgc_results_vix_daily.log", replace text
clear all
set scheme sj
set more off
...
import delimited "C:\Users\Anantha\OneDrive\Desktop\Anantha\BITS GOA\Academics\3 - 1\FRAM\Project\Data\Daily\TCI_VIX_daily", clear
rename *, lower
...
foreach var of varlist tci vix {
	gen d`var' = d.`var'
}
...
varsoc tci vix /* if tin(1992m1,) */ , exog(trend) maxlag(12)
